<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{asset('storage/ModHobFaviconFinal.png')}}" width="89" height="25" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="{{asset('storage/ModHobFaviconFinal.png')}}" width="30" height="30" alt="CoreUI Logo">
    </a>
