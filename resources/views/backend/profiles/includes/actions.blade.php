<div class="btn-group btn-group-sm" role="group" aria-label="@lang('labels.backend.boxes.actions')">
    <a href="{{ route('admin.profiles.edit', $profile) }}" class="btn btn-outline-success" data-toggle="tooltip"
       data-placement="top" title="Edit">
        <i class="fas fa-edit"></i>
    </a>
{{--    <a href="{{ route('frontent.profiles.view', $box) }}" class="btn btn-outline-primary" data-toggle="tooltip"--}}
{{--       data-placement="top" title="Manage">--}}
{{--        <i class="fas fa-tasks"></i>--}}
{{--    </a>--}}
    <a href="{{ route('admin.profiles.destroy', $profile) }}"
       data-method="delete"
